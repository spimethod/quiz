  ...
  const handleContinue = () => {
    if (selectedOption) {
      if (typeof window !== 'undefined') {
        localStorage.setItem('socialGroups', selectedOption);
      }
        ...
        <div className="max-w-[660px] w-full mx-auto">
          ...
          <div className="flex justify-center mb-2">
            <Image
              ...
              width={400}
              height={400}
              className="w-72 h-72 sm:w-80 sm:h-80 md:w-88 md:h-88 max-w-[45vh] max-h-[45vh] object-contain [zoom:110%]:w-[min(30vh,280px)] [zoom:110%]:h-[min(30vh,280px)] [zoom:125%]:w-[min(27vh,260px)] [zoom:125%]:h-[min(27vh,260px)] [zoom:150%]:w-[min(24vh,240px)] [zoom:150%]:h-[min(24vh,240px)]"
            />
          </div>
        </div>
      </main>
