    ...
    >
      <div className="max-w-[660px] w-full mx-auto pt-[30px]">
        ...
        <div className="mb-6 sm:mb-8">
          <p className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed text-left max-w-[540px] ml-[10px] [zoom:110%]:text-[min(3vw,1.25rem)] [zoom:125%]:text-[min(2.5vw,1.1rem)] [zoom:150%]:text-[min(2vw,1rem)]">
