    ...
    >
      <div className="max-w-[660px] w-full mx-auto pt-[30px]">
        ...
        <div className="mb-6 sm:mb-8 text-center">
          <div className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed [zoom:110%]:text-[min(3vw,1.25rem)] [zoom:125%]:text-[min(2.5vw,1.1rem)] [zoom:150%]:text-[min(2vw,1rem)]">
            <div>Created by psychologists and clinical specialists, Avocado operates on the most recent</div>
            <div>scientific discoveries in psychology, knowledge from more than</div>
            <div>a thousand books and thousands of real</div>
            <div>therapeutic cases.</div>
          </div>
        </div>
