    ...
    >
      <div className="flex flex-col h-full relative bg-[#f5f5f0] overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-24 flex justify-center items-center z-0">
           <div className="relative w-full h-full max-w-lg">
             <Image
               ...
               alt="Avocado Plan"
               fill
               className="object-contain object-center scale-[1.7] translate-y-20 sm:translate-y-24 -translate-x-[10px]"
               priority
             />
           </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center pointer-events-none z-10" style={{ paddingBottom: 'calc(1.5rem + 60px)' }}>
          <div className="bg-white w-full sm:max-w-[500px] rounded-t-[40px] sm:rounded-[40px] px-6 pt-10 pb-4 shadow-[0_-10px_60px_rgba(0,0,0,0.08)] pointer-events-auto" style={{ marginBottom: '3px' }}>
