...
export default function BeforeStartPage() {
  ...
  const footerContent = (
    <button
      ...
      className="bg-[#6B9D47] hover:bg-[#5d8a3d] text-white font-semibold text-base sm:text-lg md:text-xl py-2.5 sm:py-3 md:py-3.5 px-12 sm:px-16 md:px-20 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 active:scale-95 cursor-pointer w-full max-w-md select-none"
    >
      Continue
    </button>
  );
